...
const Dialogs: React.FC<DialogsType> = (props) => {
    ...
    let dialog = props.dialogPage.dialogData.map(d => <DialogItem key={d.id} id={d.id} name={d.name}
                                                                  avatar={d.avatar}/>)
    ...
    return (
        <form onSubmit={props.handleSubmit}>
            <div className={s.textArea_box}>
                <Field autoFocus={true} component={'textarea'} name={'MessageText'} placeholder={'Input you message'}/>
